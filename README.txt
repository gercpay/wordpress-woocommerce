...
=== GercPay Payment Gateway for WooCommerce ===
Contributors: Mustpay
Tags: merchant, online payment, payment gateway, acquiring, woocommerce, gercpay, payment, commerce, Apple Pay, visa, Google Pay
...
Download GercPay payment acceptance plugin for WooCommerce from the WordPress add-ons directory. Unpack this plugin into the /wp-content/plugins/ directory. After that activate it in the “Plugins” menu.
...
4. Choose how the payment will be displayed:
    * Separate payment page on the side of GercPay;
